 ...
 *
 */
public abstract class BashScriptEngine extends ScriptEngine {

	/**
	 * @param modelInstance
	 */
	public BashScriptEngine(MigUserInfoModel modelInstance) {
		super(modelInstance);
		// TODO Auto-generated constructor stub
	}
	final static Logger logger = Logger.getLogger(BashScriptEngine.class);
	/* (non-Javadoc)
	 * @see com.dell.coe.svntogit.framework.IScriptEngine#runScript(java.lang.String)
	 */
